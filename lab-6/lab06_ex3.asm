...
ADD R6, R6, #1 ;loads the value 1 into R6
LEA R0, PROMPT_USER
PUTS
...
ADD R6, R6, #0
BRp #4 ;jump to subtract 98
ADD R6, R6, #0

ADD R6, R6, #0
BRnz #23 ;jump to check if '0' or '1' or ' '
ADD R6, R6, #0

ADD R0, R0, #-15 ;subtracts 98 from first input to check if 'b'
ADD R0, R0, #-15
ADD R0, R0, #-15
ADD R0, R0, #-15
ADD R0, R0, #-15
...
ADD R0, R0, #0
BRz #51 ;jump to store
ADD R0, R0, #0

ADD R0, R0, #0
BRnp #1 ;jump to error message
ADD R0, R0, #0
...
LEA R0, ERROR_MSG
PUTS
LD R6, VAL_ONE ;loads the value 1 into R6
LEA R0, PROMPT_USER
PUTS
ADD R0, R0, #0
BRnzp INPUT_LOOP

;check if '0', '1' or SPACE

ADD R0, R0, #-15 ;subtracts 32 from input to check if SPACE
ADD R0, R0, #-15
ADD R0, R0, #-2

ADD R0, R0, #0
BRn #22 ;jump to error 2
ADD R0, R0, #0

ADD R0, R0, #0
BRp #4 ;jump to subtract 16
ADD R0, R0, #0

ADD R0, R0, #0
BRz #31 ;jump to ADD R3, R3, #1
ADD R0, R0, #0

ADD R0, R0, #-15 ;subtracts 16 from R0
ADD R0, R0, #-1

ADD R0, R0, #0
BRp #4 ;jump to subtract 1
ADD R0, R0, #0

ADD R0, R0, #0
BRz #15 ;add 48 to R0, then jump to store
ADD R0, R0, #0

ADD R0, R0, #-1

ADD R0, R0, #0
BRp #4 ;jump to error 2
ADD R0, R0, #0

ADD R0, R0, #0
BRz #7 ;add 49 to R0, then jump to store
ADD R0, R0, #0
...
ADD R0, R0, #1 ;start here to add 49
ADD R0, R0, #3 ;start here to add 48
ADD R0, R0, #15
ADD R0, R0, #15
ADD R0, R0, #15
...
ADD R6, R6, #-1 ;subtracts 1 from R6
...
LD R6, VAL_ZERO ;loads the value 0 into R6
...
ERROR_MSG2 .STRINGZ "Invalid Input, Valid Inputs: '0','1' or SPACE \n"
NEWLINE_0 .STRINGZ "\n"
