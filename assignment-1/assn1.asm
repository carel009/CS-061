...
DEC_0	.FILL  #0	;Put the value 0 into the memory here
DEC_6	.FILL  #6	;Put the value 6 into the memory here
DEC_12	.FILL  #12	;Put the value 12 into the memory here
